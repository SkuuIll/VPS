#!/usr/bin/env python3
import socket, threading, _thread as thread, select, signal, sys, time, getopt
    ...
    def run(self):
        try:
            ...
            if hostPort == b'':
                ...
                hostPort = hostPort.decode('utf-8', errors='ignore')
            ...
            if hostPort != '':
                ...
                if isinstance(passwd, bytes):
                    passwd = passwd.decode('utf-8', errors='ignore')
